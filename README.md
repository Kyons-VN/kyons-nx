...
Libraries are shareable across libraries and applications. They can be imported from `@kyonsvn/mylib`.
...
```
AWS_PROFILE=kyons-importer aws s3 rm --recursive s3://student.kyons.vn/
