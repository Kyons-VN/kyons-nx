...
import { Content, Mana, Part, TextPart } from '@data/chat/chat-model';
...
import { isCommand } from '@share-utils/utils';
...
@Component({
  standalone: true,
  imports: [CommonModule, RouterModule, TopMenuComponent, MessagesComponent, ChatboxComponent, ChatbotSidebarComponent],
