...
class User implements IUser {
  ...
  username: string;
  school: School;
  constructor({ email: email, first_name: first_name, last_name: last_name, username: username, school: school }: { email: string, first_name: string, last_name: string, username: string, school: School }) {
    this.email = email;
