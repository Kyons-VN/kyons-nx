"use strict";
(self["webpackChunkstudent"] = self["webpackChunkstudent"] || []).push([["node_modules_firebase_compat_messaging_dist_esm_index_esm_js"],{
...
/* harmony import */ var D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
/* harmony import */ var _firebase_app_compat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/app-compat */ 36391);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 73425);
/* harmony import */ var _firebase_messaging__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @firebase/messaging */ 22910);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 32081);
/* harmony import */ var _firebase_messaging_sw__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/messaging/sw */ 23931);
...
class MessagingCompatImpl {
  ...
  getToken(options) {
    var _this = this;
    return (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
/* harmony export */ });
/* harmony import */ var D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
/* harmony import */ var _firebase_installations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/installations */ 57478);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 73425);
/* harmony import */ var idb__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! idb */ 6470);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 32081);
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/app */ 32839);
...
function _migrateOldDatabase() {
  _migrateOldDatabase = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (senderId) {
    ...
    const db = yield (0,idb__WEBPACK_IMPORTED_MODULE_3__.openDB)(OLD_DB_NAME, OLD_DB_VERSION, {
      upgrade: function () {
        var _ref = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (db, oldVersion, newVersion, upgradeTransaction) {
          var _a;
          if (oldVersion < 2) {
...
function _dbGet() {
  _dbGet = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
...
function _dbSet() {
  _dbSet = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
...
function _dbRemove() {
  _dbRemove = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
    const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
...
function _requestGetToken() {
  _requestGetToken = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _requestUpdateToken() {
  _requestUpdateToken = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _requestDeleteToken() {
  _requestDeleteToken = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, token) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _getHeaders() {
  _getHeaders = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
    appConfig,
    installations
  }) {
...
function _getTokenInternal() {
  _getTokenInternal = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
...
function _deleteTokenInternal() {
  _deleteTokenInternal = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
    const tokenDetails = yield dbGet(messaging.firebaseDependencies);
    if (tokenDetails) {
      yield requestDeleteToken(messaging.firebaseDependencies, tokenDetails.token);
...
function _updateToken() {
  _updateToken = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, tokenDetails) {
    try {
...
function _getNewToken() {
  _getNewToken = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _getPushSubscription() {
  _getPushSubscription = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (swRegistration, vapidKey) {
...
function _stageLog() {
  _stageLog = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, internalPayload) {
...
function _onSubChange() {
  _onSubChange = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
    var _a, _b;
    const {
      newSubscription
    } = event;
...
function _onPush() {
  _onPush = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
...
function _onNotificationClick() {
  _onNotificationClick = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event) {
    var _a, _b;
...
function _getWindowClient() {
  _getWindowClient = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url) {
    const clientList = yield getClientList();
...
function _isSwSupported() {
  _isSwSupported = (0,D_Documents_KYONS_source_kyons_nx_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _firebase_messaging_compat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/messaging-compat */ 82774);


/***/ })

}]);
//# sourceMappingURL=node_modules_firebase_compat_messaging_dist_esm_index_esm_js.30ce3ad1d6873247.js.map